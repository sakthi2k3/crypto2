...
//               Prediction:
//             </Typography>
//             <Typography style={{fontFamily: "Montserrat",marginLeft:"10px"}}>
//             <a href={`/prediction/${coin?.name}/`} style={{fontSize:"22px"}}>
//               Click Here
//             </a>
//             </Typography>
//             </span>
...
//             </Typography>
//             <Typography style={{fontFamily: "Montserrat",marginLeft:"10px"}}>
//             <a href={`https://www.binance.com/en-IN/how-to-buy/${coin?.name.toLowerCase()}`} style={{fontSize:"22px"}}>
//               Click Here
//             </a>
//             </Typography>
//             </span>
  ...
  return (
    <div className={classes.container}>
      <div className={classes.sidebar}>
        ...
        <Input
        style={{backgroundColor:"#ebebeb",height: 50,width:100}}
        type="number"
        name='crypto'
        value={input.crypto}
      ...
      <Select
              ...
              value={currency}
              style={{ width: 85, height: 50,marginLeft:'45px',backgroundColor:"#aafaa2" }}
      ...
      style={{backgroundColor:"#ebebeb",margin:"0px",height: 50,width:100}}
      type="number"
      name="price"
      value={input.price}
      onChange={(e)=>updateinput(e)}
